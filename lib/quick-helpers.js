 ...
 * @param {{ task: string, projectDir?: string, slug?: string, now?: Date, milestoneSlug?: string }} opts
...
function setup(opts) {
  ...
  const milestoneSlug = o.milestoneSlug ? String(o.milestoneSlug).trim() : '';
  const frontmatter = milestoneSlug
