...
function writeSummary(root, planId, summaryData, options = {}) {
  ...
  // v0.8 P1: stamp end-commit when git is available. See lib/milestone.js
  // for the canonical path; this internal helper mirrors the behaviour
  // so existing tests + code paths stay consistent.
