 ...
 * @param {string} projectDir
 */
function _writeInvokedSkillState(slug, phaseId, invokedSkill, projectDir) {
  try {
    ...
    const updated = Object.assign({}, existing, { invoked_skill: invokedSkill });
...
function markPhaseComplete(slug, phaseId, summaryText, opts) {
  ...
  _writeInvokedSkillState(slug, phaseId, _parseInvokedSkill(summaryText), projectDir);
