...
function loadPhaseTemplate(name, opts) {
  // v1.4 Decision #1: inline phase-templates (declared in `phase_templates:`
  // at the top of the workflow file) shadow project + builtin disk lookups.
  const inline = opts && opts.inlinePhaseTemplates;
