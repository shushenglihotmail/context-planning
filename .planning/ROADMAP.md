...
- [ ] 49-02: `lib/milestone.js` — `readPhases(roadmapMd)` returning `Phase[]` for all ROADMAP shapes + milestone-tier DESIGN.md/STATE.md scaffolding; ship `test/unit-milestone-reader.js` (~30 assertions).
