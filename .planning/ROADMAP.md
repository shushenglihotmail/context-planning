...
- [x] 52-03: Bump package.json to 1.2.0; commit; tag v1.2.0; publish to npm.
...
- [x] 60-04: Checkpoint protocol — runs/state.json + restart_phase output reversion
- [x] 60-05: Integration tests across the unified runtime
...
- [x] 62-03: complete-milestone.yaml workflow + /cp-complete-milestone thin wrapper

### Phase 63: Docs + MIGRATION-v1.4.md + v1.4.0 release

Plans:
- [ ] 63-01: Docs refresh (README, CLI help, workflow guide)
