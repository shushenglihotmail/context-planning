...
#   phase: "61"     (for phase-tier DESIGN.md)
#   milestone_slug: "v1-4-workflow-driven-quick-and-milestone"  (for milestone-tier DESIGN.md)
phase: "61"
...
# Design: Phase 61: Reserved CLI helpers set 1: cp project update + milestone-setup-check + milestone-finalize
