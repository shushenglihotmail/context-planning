...
- **Framework Bug Fixes from v1.8.1 Retro (deferred)**: six process-discipline gaps surfaced when a sibling repo ran v1.8.1 end-to-end (A roadmap-scanner, B write-summary frontmatter-only, C complete-milestone STATE regen, D doctor fix-dual-plan, E sham-review-log audit rule, F skill-load attestation). Deferred until v1.8.2 (Bug G: milestone-binding fan-out wiring) ships, because dogfooding the milestone workflow for this fix hit the very Bug G that blocks materialize: roadmap-phases. Design preserved at `.planning/milestones/v1-9-framework-bug-fixes-from-v1-8-1-retro/DESIGN.md`. — v1.9 (deferred)
...
---
*Last updated: 2026-06-01 — closed v1.8 + v1.8.1; deferring v1.9 until v1.8.2 Bug G (milestone-binding fan-out) ships*
