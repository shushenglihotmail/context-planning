...
### Active
- *(none — v1.9 just shipped; next milestone TBD)*
...
---
*Last updated: 2026-06-01 — shipped v1.9 (six framework bug fixes + cross-cutting attestation false-positive fix); driven through the milestone workflow as production dogfood of v1.8.2's Bug G fan-out.*
